...
import static com.digitalinnovation.heroesapi.constants.HeroesConstants.HEROES_ENDPOINT_LOCAL;
...
public class HeroesController {
            ...
            public Flux<Heroes> gettAllItems(){
            ...
            public Mono<ResponseEntity<Heroes>> findByIdHero(@PathVariable String id){
                log.info("requesting the hero id {}",id);
                return heroesService.findByIdHereo(id)
